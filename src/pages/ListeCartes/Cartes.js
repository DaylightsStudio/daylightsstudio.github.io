    ...
    return (
        <div>
            ...
            <div className="flexContainer">
                ...
                <div className="item">
                    <img src={Eckko_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Fakefoxx_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Aska_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Postal_lady_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Jukebox_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Dunkie_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Ribsy_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Misterk_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Dcriss_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Recrue}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Conflit_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Karen_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Os_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Plane_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Reverse_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Verse_card}  alt="une carte"></img>
                ...
                <div className="item">
                    <img src={Eckko_ev_card}  alt="une carte"></img>
